...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/admin/kelolawarga/create.css') }}">
@endpush

@section('content')
<div class="warga-page warga-create">
    ...
    <div class="warga-header">
        <div class="header-content">
            <h1 class="warga-title">
                <span class="warga-icon"><i class="fa-solid fa-user-plus"></i></span>
                Tambah Data Warga
            </h1>
            <p class="warga-subtitle">Tambah warga baru ke dalam sistem</p>
        </div>
    </div>
    ...
    <div class="warga-card form-card">
        ...
        <form action="{{ route('admin.kelolawarga.store') }}" method="POST" enctype="multipart/form-data" id="wargaForm">
            @csrf
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" name="user_id" class="input-modern" value="{{ old('user_id') }}" required>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" name="nik" class="input-modern" value="{{ old('nik') }}" required maxlength="16">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" name="kk" class="input-modern" value="{{ old('kk') }}" required>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" name="name" class="input-modern" value="{{ old('name') }}" required>
                        </div>
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" name="tempat_lahir" class="input-modern" value="{{ old('tempat_lahir') }}">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="date" name="tanggal_lahir" class="input-modern" value="{{ old('tanggal_lahir') }}">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="number" name="umur" class="input-modern" value="{{ old('umur') }}">
                        </div>
                ...
                <div class="form-grid">
                    <div class="form-group full-width">
                        ...
                        <div class="input-wrapper">
                            ...
                            <textarea name="alamat" class="input-modern textarea" rows="3" required>{{ old('alamat') }}</textarea>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" name="rw" class="input-modern" value="{{ old('rw') }}">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" name="rt" class="input-modern" value="{{ old('rt') }}">
                        </div>
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" name="pekerjaan" class="input-modern" value="{{ old('pekerjaan') }}">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <select name="pendidikan_akhir" class="input-modern">
                                ...
                                <option value="SMA" {{ old('pendidikan_akhir') == 'SMA' ? 'selected' : '' }}>SMA</option>
                                <option value="D1" {{ old('pendidikan_akhir') == 'D1' ? 'selected' : '' }}>D1</option>
                                <option value="D2" {{ old('pendidikan_akhir') == 'D2' ? 'selected' : '' }}>D2</option>
            ...
            <div class="form-section">
                ...
                <div class="file-upload-wrapper">
                    ...
                    <label for="fotoInput" class="file-label">
                        ...
                        <div class="file-text">
                            <span class="file-main">Klik untuk upload foto</span>
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn btn-success" id="btnSubmit">
                    <span class="btn-text"><i class="fa-solid fa-floppy-disk"></i> Simpan Data</span>
...
@push('scripts')
    <script src="{{ asset('js/admin/kelolawarga/create.js') }}"></script>
@endpush