...
@section('title', 'Tambah Syarat - ' . $layanan->nama_layanan)

@section('content')
<link rel="stylesheet" href="{{ asset('css/admin/pendudukrequirement/create.css') }}">
<script src="{{ asset('js/admin/pendudukrequirement/create.js') }}" defer></script>
...
<div class="admin-container">
    ...
    <div class="card-glass form-card">
        <form action="{{ route('admin.pendudukrequirement.store') }}" method="POST" id="syaratForm">
            @csrf
            ...
            <div class="form-grid">
                <div class="form-group full-width">
                    ...
                    <div class="input-wrapper">
                        <input type="text" name="nama_syarat" class="input-modern" placeholder="Contoh: Foto KTP" value="{{ old('nama_syarat') }}" required>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        <select name="tipe" class="input-modern" required>
                            ...
                            <option value="text" {{ old('tipe') == 'text' ? 'selected' : '' }}>📝 Input Teks</option>
                        </select>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="checkbox-wrapper">
                        <label class="checkbox-label">
                            <input type="checkbox" name="wajib" value="1" {{ old('wajib') ? 'checked' : '' }}>
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn btn-success" id="btnSubmit">
                    <span class="btn-text">Simpan Syarat</span>
